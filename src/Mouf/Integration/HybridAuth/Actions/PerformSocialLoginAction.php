...
class PerformSocialLoginAction implements ActionInterface {
	...
	private function insertIntoAuthentications($userId, $providerName, \Hybrid_User_Profile $user_profile) {
		$this->dbalConnection->insert('authentications', ['user_id' => $userId,
                                                            ...
                                                            'age' => $user_profile->age ? $user_profile->age : null,
                                                            'birth_day' => $user_profile->birthDay ? $user_profile->birthDay : null,
                                                            'birth_month' => $user_profile->birthMonth ? $user_profile->birthMonth : null,
                                                            'birth_year' => $user_profile->birthYear ? $user_profile->birthYear : null,
